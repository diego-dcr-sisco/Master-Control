...
@section('login')
    <style>
        .bg-sisco {
            background: #7A9FDF;
            background: linear-gradient(90deg, rgba(122, 159, 223, 1) 0%, rgba(133, 200, 242, 1) 33%, rgba(226, 242, 99, 1) 66%, rgba(163, 166, 86, 1) 100%);
        }
    </style>
    <div class="container-fluid vh-100 bg-sisco p-0">
